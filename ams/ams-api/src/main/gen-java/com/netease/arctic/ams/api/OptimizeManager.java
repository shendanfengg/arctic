...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2023-09-20")
public class OptimizeManager {
  ...
  public interface Iface {
    ...
    public OptimizeTask pollTask(int queueId, JobId jobId, java.lang.String attemptId, long waitTime, java.lang.String container) throws com.netease.arctic.ams.api.NoSuchObjectException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void pollTask(int queueId, JobId jobId, java.lang.String attemptId, long waitTime, java.lang.String container, org.apache.thrift.async.AsyncMethodCallback<OptimizeTask> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public OptimizeTask pollTask(int queueId, JobId jobId, java.lang.String attemptId, long waitTime, java.lang.String container) throws com.netease.arctic.ams.api.NoSuchObjectException, org.apache.thrift.TException
    {
      send_pollTask(queueId, jobId, attemptId, waitTime, container);
      return recv_pollTask();
    }

    public void send_pollTask(int queueId, JobId jobId, java.lang.String attemptId, long waitTime, java.lang.String container) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void pollTask(int queueId, JobId jobId, java.lang.String attemptId, long waitTime, java.lang.String container, org.apache.thrift.async.AsyncMethodCallback<OptimizeTask> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      pollTask_call method_call = new pollTask_call(queueId, jobId, attemptId, waitTime, container, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class pollTask_call extends org.apache.thrift.async.TAsyncMethodCall<OptimizeTask> {
      ...
      public pollTask_call(int queueId, JobId jobId, java.lang.String attemptId, long waitTime, java.lang.String container, org.apache.thrift.async.AsyncMethodCallback<OptimizeTask> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class pollTask<I extends Iface> extends org.apache.thrift.ProcessFunction<I, pollTask_args> {
      ...
      public pollTask_result getResult(I iface, pollTask_args args) throws org.apache.thrift.TException {
        pollTask_result result = new pollTask_result();
        try {
          result.success = iface.pollTask(args.queueId, args.jobId, args.attemptId, args.waitTime, args.container);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class pollTask<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, pollTask_args, OptimizeTask> {
      ...
      public void start(I iface, pollTask_args args, org.apache.thrift.async.AsyncMethodCallback<OptimizeTask> resultHandler) throws org.apache.thrift.TException {
        iface.pollTask(args.queueId, args.jobId, args.attemptId, args.waitTime, args.container,resultHandler);
      }
    }
  ...
  public static class pollTask_args implements org.apache.thrift.TBase<pollTask_args, pollTask_args._Fields>, java.io.Serializable, Cloneable, Comparable<pollTask_args>   {
    ...
    private static final org.apache.thrift.protocol.TField CONTAINER_FIELD_DESC = new org.apache.thrift.protocol.TField("container", org.apache.thrift.protocol.TType.STRING, (short)5);
    ...
    public pollTask_args setContainer(@org.apache.thrift.annotation.Nullable java.lang.String container) {
      this.container = container;
      return this;
    }
