...
public class HMSMockServer {
  ...
  private void setupMetastoreDB(String jdbcUrl) throws SQLException, IOException {
    ...
    InputStream inputStream = new BufferedInputStream(new FileInputStream("C:\\Users\\shendanfeng01\\opensource\\arctic\\hive\\src\\test\\resources\\hive-schema-3.1.0.derby.sql"));
